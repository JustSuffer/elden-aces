...
export const MASTER_CLASSES: Record<ClassName, ClassData> = {
  ...
  Vessel: {
    ...
    role: "Summoner",
    initialHP: 40,
    passiveDescription: "Sigma, Delta ve Gamma kartları el limitini doldurmaz.",
    abilityScales: [
        { count: 1, effectDescription: "-" },
        { count: 2, effectDescription: "+Sigma (Σ) ve Delta (Δ)" },
        { count: 3, effectDescription: "+Sigma (Σ) ve Delta (Δ)" },
        { count: 4, effectDescription: "+Sigma (Σ) ve Delta (Δ)" },
        { count: 5, effectDescription: "+5 Kart (Σ/Δ) + Gamma (γ)" },
    ],
