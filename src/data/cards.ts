...
export const DECK: Card[] = [
  ...
  },
  {
    ...
    special: "delta",
    color: "primary",
    description: "2x damage effect. With Twisted transforms to Sigma.",
  },
  {
    id: "sigma-1",
    name: "Sigma",
    ...
    special: "sigma",
    color: "primary",
    description: "Reverse of Delta. With Twisted transforms to Delta.",
  },
  {
    id: "deflate-1",
    name: "Deflate",
    ...
    special: "deflate",
    color: "primary",
    description: "Cancels all opponent's special card effects this round.",
  },
  {
    id: "deflate-2",
    name: "Deflate",
